...
export const magicalWeaponAbilitiesTable = [
  ...
  { range: '9–10', ability: 'Blighted', description: 'The weapon was created to slaughter normal human beings. Against baseline humans, it rolls damage twice and takes the better result. It functions without issues even in the hands of a baseline wielder; its creators were as glad to see internecine strife as any other kind.' },
  { range: '11–12', ability: 'Bloodbound', description: 'The weapon forms a symbiotic bond with the wielder. So long as they are wielding the weapon, they automatically stabilize from any survivable mortal wound and automatically regenerate one hit point every hour as magical healing. Once per day, a failed Physical or Mental saving throw may be re-rolled as the weapon shares the strain on the wielder.' },
  { range: '13–14', ability: 'Bloodthirsty', description: 'When the weapon’s wielder reduces a creature with at least one hit die to zero hit points, they regain 1d8 plus the creature’s hit dice in lost hit points. This healing cannot take them above their usual maximum hit points.' },
  { range: '15–16', ability: 'Despairing', description: 'The weapon drains a victim’s courage and hope. By accepting a point of System Strain as an Instant action when they hit a target, they can force the victim to make an immediate Morale check at a -1 penalty. This effect can be applied to a given target only once per scene.' },
  { range: '17–18', ability: 'Devoted', description: 'The weapon bonds with the first possessor to pick it up after the death of their last wielder. Until the wielder dies or intentionally discards it, it remains bound to them. Under no circumstances will it or its projectiles harm its wielder, and it can be teleported back to their hand as an On Turn action. The first time the wielder would be reduced to zero hit points during a day, they may accept a point of System Strain to let the weapon leap up and block the damage, assuming the damage is the sort the weapon could block.' },
  { range: '19–20', ability: 'Devouring', description: 'The weapon bites pieces out of a victim’s body or spirit. Damage inflicted by a devouring weapon cannot be healed until the end of the scene, whether by regeneration or other healing abilities. Creatures brought to zero hit points by the weapon are killed immediately and largely dismembered. Every time the weapon kills a living creature, the bearer gains twice their hit dice in points of healing.' },
  { range: '21–22', ability: 'Effortless', description: 'The weapon is supernaturally handy and easy to use. It has an effective Encumbrance of zero, cannot be unintentionally dropped or disarmed, and will hang suspended in space by the bearer for up to a minute if they should need their weapon hand free for some other purpose during a round. Large Effortless weapons will automatically compact or contort themselves to remain convenient to carry or use in even the most awkward circumstances.' },
  { range: '23–24', ability: 'Energetic', description: 'When in use, the weapon or its projectiles are wreathed in flame, lightning, killing frost, or some other form of energy. Minor energetic weapons do +2 damage on a hit, while major or great energetic weapons do 1d6+2 additional damage. This bonus doesn’t add to the weapon’s Shock.' },
  { range: '25–26', ability: 'Enervating', description: 'The weapon drains the vital energy from those it harms. A creature hit by the weapon must make a Physical saving throw or lose their next Move action. This draining effect can’t apply more than once to a creature until their next turn.' },
  { range: '27–28', ability: 'Enraging', description: 'The weapon ignites a bloodthirsty fury in the bearer. As an On Turn action, the wielder can become enraged. While enraged, they gain a +2 bonus to hit and damage rolls, can reroll any failed Mental saving throws that would stop them from fighting, and can continue fighting for one round after being reduced to zero hit points. Enraged wielders never fail a Morale check. Every round, however, they must either attack someone, seek to get close enough to attack someone, or spend their Main Action to come out of the rage.' },
  { range: '29–30', ability: 'Forfending', description: 'The first Screen Ally skill check the bearer attempts each round is an automatic success. While they are using the Screen Ally action, they are immune to Shock damage and gain a +2 bonus to their Armor Class.' },
  { range: '31–32', ability: 'Fortifying', description: 'The weapon has a supplementary pool of System Strain; up to three points of it can be accumulated by the weapon in place of its bearer when System Strain is incurred. This System Strain decreases by one point per night. A bearer can benefit from only one of these weapons at a time, and its pool is shared among all its potential users.' },
  ...
  { range: '35–36', ability: 'Hunting', description: 'The weapon was fashioned to slay monstrous beasts. Against non-sentient foes, the weapon rolls any damage it inflicts twice and takes the higher.' },
  { range: '37–38', ability: 'Illuminating', description: 'The weapon casts light up to 60’ in radius at the wielder’s mental command. By accepting one point of System Strain, the bearer may make the light visible only to them and their allies; such selective light lasts for an hour.' },
  ...
  { range: '61–62', ability: 'Piercing', description: 'This weapon inflicts its Shock damage on everything the wielder attacks with it, even if the target is normally immune to Shock. However, the weapon never inflicts more than its Shock damage, whether or not the attack roll hits. If the weapon doesn’t normally do Shock, it gains a base Shock rating of 2/-. ' },
  { range: '63–64', ability: 'Radioactive', description: 'The weapon emits a constant invisible radiance of toxic power. As an On Turn action the bearer can drop or restore the safeguards on the weapon. While unleashed the weapon glows deep blue and everyone within melee range of the bearer, including the bearer, will take 1d10 damage at the end of the bearer’s turn each round unless somehow shielded against radioactivity. Creatures with one hit die automatically die if so poisoned, regardless of the damage roll.' },
  { range: '65–66', ability: 'Rampaging', description: 'Whenever this weapon kills a creature with at least one hit die, its bearer may immediately make another attack on any target within range. If no additional targets are available, the wielder instead gets an instant free Move action.' },
  { range: '67–68', ability: 'Rectifying', description: 'The weapon is exceptionally potent against undead, robots, and other synthetic life forms. All damage done to such creatures is rolled twice, with the better number taken. The weapon can affect even insubstantial or otherwise immune entities of that type, and an undead creature killed by this weapon is permanently put to rest barring tremendous powers of revivification or immortality.' },
  { range: '69–70', ability: 'Returning', description: 'If thrown, dropped, or disarmed, the weapon can be called back to the owner’s hand as an On Turn action. A new possessor becomes the owner after carrying it for at least an hour.' },
  { range: '71–72', ability: 'Sacrificial', description: 'The weapon’s violence is fueled by the wielder’s own life force. As an Instant action on a hit, the wielder may accept 1d8 hit points of damage; double this damage is inflicted on the target. This damage may be enough to mortally wound the weapon’s own wielder.' },
  { range: '73–74', ability: 'Shattering', description: 'The weapon can be used to smash inanimate objects and barriers. Once per scene, with one minute of careful preparation, the wielder can break a man-sized hole in a normal exterior wall or up to a foot of stone. If they accept a point of System Strain, they can do so as a Main Action instead, and may do so as often as they have System Strain available. Shattering blows inflict no special damage on animate targets.' },
  { range: '75–76', ability: 'Shieldbreaking', description: 'The weapon ignores all shields, both their Armor Class bonus and their Shock protection. Non-magical shields are destroyed by the weapon’s attack, whether or not the attack hits.' },
  { range: '77–78', ability: 'Shocking', description: 'The weapon’s Shock damage is increased by 2 points. If it has no natural Shock score, it gains a Shock rating of 2/AC 15.' },
  { range: '79–80', ability: 'Shrieking', description: 'At the wielder’s will, the weapon emits an ear-splitting shriek while in use. The wielder and up to a dozen allies are immune to this effect, but others who are within 60 feet of the wielder are unable to hear themselves speak, and spellcasters must make Wis/Magic skill checks at a difficulty of 7 plus the spell level to successfully cast spells without fumbling the incantations. All Instinct checks made within the area suffer a -2 penalty. The shrieking is completely inaudible outside the sixty-foot radius of effect.' },
  { range: '81–82', ability: 'Skittering', description: 'When the weapon is shot or thrown at a location within sixty feet, the wielder may instantly appear where the weapon was thrown or struck as an On Turn action, provided they do so in the same round. If thrown, they appear with the weapon in their hand. This ability may be used only once per round.' },
  { range: '83–84', ability: 'Skytreading', description: 'The weapon’s bearer falls gently from any height, becoming immune to falling damage. By accepting one point of System Strain as an On Turn action, they may fly at their full normal movement rate until the end of the round.' },
  { range: '85–86', ability: 'Slaughtering', description: 'The weapon hideously disjects its victims. Any target reduced to zero hit points by the weapon is immediately killed and violently dismembered. Any enemies with a Morale score of less than 12 who are within melee range of the slaughtered victim take the weapon’s Shock damage as emotional trauma and horror, even if they’re normally immune to Shock. Weapons that don’t do Shock damage inflict 2 points of damage to these bystanders instead. This weapon cannot be used for less than lethal attacks.' },
  { range: '87–88', ability: 'Souleating', description: 'While this weapon may or may not devour the actual soul of the target, such as it may be, it channels great vital force to the wielder. Every time they kill a sentient creature with the weapon, they lose one accumulated System Strain point. This effect can trigger only once per scene.' },
  { range: '89–90', ability: 'Spellcleaving', description: 'At a cost of a Move action and one System Strain gained by the wielder, the weapon can apply an Extirpate Arcana spell effect to any target point within range of the weapon. The spell is cast as if by a tenth level High Mage with a total Int/Magic skill bonus of +3. This power can be used only once per scene.' },
  { range: '91–92', ability: 'Terrifying', description: 'The weapon is wrought with psychic distress, creating an intense burden of fear in those who oppose its wielder. Whenever the wielder does something that provokes a Morale or Instinct check, any targets who can see them must make the check at a -1 penalty. This effect does not stack with multiple weapons, nor does it affect those with Morale 12.' },
  { range: '93–94', ability: 'Toxic', description: 'The weapon sweats a potent toxin. When it hits a living target, the wielder may accept a point of System Strain to trigger the toxin’s effect; the victim is racked with spasms of torment and cannot speak or cry out while they remain poisoned. Each round they take 1d8 damage at the end of their turn; they can try to throw off the poison’s effects by making a successful Physical saving throw at the end of their round. A creature can only be poisoned once by this weapon at any one time.' },
  { range: '95–96', ability: 'Vengeful', description: 'The weapon will always succeed at any attack roll made against a foe who has harmed the wielder within the past round, assuming success is physically possible. Such vengeful strikes roll damage twice and take the higher roll.' },
  { range: '97–98', ability: 'Versatile', description: 'The weapon shifts forms to better suit the bearer’s need. As an On Turn action, the wielder can give it one of the following qualities it doesn’t already have: Subtle, Long, or Throwable. If thrown, it returns to the bearer’s hand at the end of the round.' },
  { range: '99–00', ability: 'Vigilant', description: 'The weapon’s bearer cannot be surprised by anyone who is carrying a manufactured weapon. The bearer does not need to sleep, though they do not recover lost hit points or accumulated System Strain without doing so.' }
];
